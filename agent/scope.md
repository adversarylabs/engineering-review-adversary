...
- Test or integration harnesses proven directly runnable on a developer host that combine privileged persistent host mutation with live service or global-workload control and lack a dominating CI-only, explicit opt-in, disposable-environment, or existing-service refusal boundary
